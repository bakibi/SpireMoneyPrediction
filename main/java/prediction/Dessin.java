...
import javax.swing.*;
/*
	Cette classe est pour visualiser les donnees
*/
public class Dessin {

	/**
		Cette methode static dessine un graphe qui contient les donnees predicts , et actuals

	*/
	public static void dessinerGraphe(double[] predicts, double[] actuals, String name) {
